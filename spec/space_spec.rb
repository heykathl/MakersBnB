...
describe '.create' do
  it 'adds a new space listing' do
    ...
    space = Space.create(name: '1 bed castle', description: 'This place rocks', price_per_night: '100', available_from: '2022-04-21', available_to: '2022-05-21', user_id: user.id)
